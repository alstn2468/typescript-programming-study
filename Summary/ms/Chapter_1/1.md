...
![hello.ts](./images/1.png)

#### Typescript 코드 트랜스파일하기

아래의 명령어를 터미널에서 실행한다.<br/>

![Transpile Typescript File Command](./images/2.png)

작성한 Typescript가 Javascript로 **트랜스파일**되어 나온다.<br/>

![Transpile Typescript File Result](./images/3.png)

#### 트랜스파일된 Javascript코드 실행하기

**트랜스파일**된 Javascript는 `node`명령어로 실행시킬 수 있다.<br/>

![Excute Transpiled Javascript Code](./images/4.png)
...
![Excute Typescript File using ts-node](./images/5.png)